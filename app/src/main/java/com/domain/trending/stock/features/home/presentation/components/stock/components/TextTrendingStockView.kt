package com.domain.trending.stock.features.home.presentation.components.stock.components
...
@Composable
fun TextTrendingStockView(clicked: () -> Unit = {})
{
    ...
    Box(
        ...
        Row(
            ...
            Text(
                text = stringResource(id = R.string.trending_stock),
                fontSize = 15.sp,
