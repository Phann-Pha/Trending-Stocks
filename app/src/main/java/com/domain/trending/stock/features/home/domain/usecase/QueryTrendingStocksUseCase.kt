...
@ViewModelScoped
class QueryTrendingStocksUseCase @Inject constructor(private val repository: StockRepository)
{
    suspend fun invoke(): Flow<List<StockModel>> = repository.onGetTrendingStocks()
}